...
In your cover letter, please focus on the kinds of questions you might want to pursue, given the focus of the project, and how your skills or experience would contribute to answering such questions. Brevity is appreciated, references are welcome. The earliest possible starting date is March 1, but later dates can be accomodated. Please include your preferred starting date.
